...
export default function PageNotFound({}) {
  ...
  // AuthProvider already resolved this once at app boot — no need for a
  // second, independent base44.auth.me() call just to check admin status.
      ...
      <div className="max-w-md w-full">
        <div className="text-center space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="text-7xl font-light text-slate-300 dark:text-slate-700">
              404
            </h1>
          ...
          {isAuthenticated && user?.role === "admin" && (
            <div className="mt-8 p-4 bg-muted rounded-lg border border-border">
              <div className="flex items-start space-x-3">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-orange-100 dark:bg-orange-950/40 flex items-center justify-center mt-0.5">
